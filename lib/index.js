...
const pageFound$ = pageFoundSubject$.pipe(skip(1), buffer(navigationEvents$.pipe(filter((env) => env === "navEnd"))));
...
// const replace = (location: string) => page(location);
...
export class EagRouter extends LitElement {
    ...
    connectedCallback() {
        ...
        // Install routes
        this.installRoute();
        this.subs.push(pageFound$.subscribe((found) => {
            // console.log(found);
        }));
    }
